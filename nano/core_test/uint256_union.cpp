...
{
	ASSERT_EQ ("0", nano::amount (nano::uint128_t ("0")).format_balance (nano::mbdm_ratio, 0, false));
	ASSERT_EQ ("0", nano::amount (nano::uint128_t ("0")).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("340,282,366", nano::amount (nano::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")).format_balance (nano::mbdm_ratio, 0, true));
	ASSERT_EQ ("340,282,366.920938463463374607431768211455", nano::amount (nano::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")).format_balance (nano::mbdm_ratio, 64, true));
	...
	ASSERT_EQ ("340,282,366", nano::amount (nano::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (nano::mbdm_ratio, 0, true));
	ASSERT_EQ ("340,282,366.920938463463374607431768211454", nano::amount (nano::uint128_t ("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (nano::mbdm_ratio, 64, true));
	...
	ASSERT_EQ ("170,141,183", nano::amount (nano::uint128_t ("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (nano::mbdm_ratio, 0, true));
	ASSERT_EQ ("170,141,183.460469231731687303715884105726", nano::amount (nano::uint128_t ("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")).format_balance (nano::mbdm_ratio, 64, true));
	...
	ASSERT_EQ ("1", nano::amount (nano::uint128_t ("1000000000000000000000000000000")).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("1.2", nano::amount (nano::uint128_t ("1200000000000000000000000000000")).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("1.23", nano::amount (nano::uint128_t ("1230000000000000000000000000000")).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("1.2", nano::amount (nano::uint128_t ("1230000000000000000000000000000")).format_balance (nano::mbdm_ratio, 1, true));
	ASSERT_EQ ("1", nano::amount (nano::uint128_t ("1230000000000000000000000000000")).format_balance (nano::mbdm_ratio, 0, true));
	ASSERT_EQ ("< 0.01", nano::amount (nano::xrb_ratio * 10).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("< 0.1", nano::amount (nano::xrb_ratio * 10).format_balance (nano::mbdm_ratio, 1, true));
	ASSERT_EQ ("< 1", nano::amount (nano::xrb_ratio * 10).format_balance (nano::mbdm_ratio, 0, true));
	ASSERT_EQ ("< 0.01", nano::amount (nano::xrb_ratio * 9999).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("0.01", nano::amount (nano::xrb_ratio * 10000).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("123456789", nano::amount (nano::mbdm_ratio * 123456789).format_balance (nano::mbdm_ratio, 2, false));
	ASSERT_EQ ("123,456,789", nano::amount (nano::mbdm_ratio * 123456789).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("123,456,789.12", nano::amount (nano::mbdm_ratio * 123456789 + nano::kbdm_ratio * 123).format_balance (nano::mbdm_ratio, 2, true));
	ASSERT_EQ ("12-3456-789+123", nano::amount (nano::mbdm_ratio * 123456789 + nano::kbdm_ratio * 123).format_balance (nano::mbdm_ratio, 4, true, std::locale (std::cout.getloc (), new test_punct)));
}
...
TEST (uint128_union, decode_decimal)
{
	...
	ASSERT_FALSE (amount.decode_dec ("340282366.920938463463374607431768211454", nano::mbdm_ratio));
	ASSERT_EQ (std::numeric_limits<nano::uint128_t>::max () - 1, amount.number ());
	ASSERT_TRUE (amount.decode_dec ("340282366.920938463463374607431768211456", nano::mbdm_ratio));
	ASSERT_TRUE (amount.decode_dec ("340282367", nano::mbdm_ratio));
	ASSERT_FALSE (amount.decode_dec ("0.000000000000000000000001", nano::mbdm_ratio));
	ASSERT_EQ (1000000, amount.number ());
	ASSERT_FALSE (amount.decode_dec ("0.000000000000000000000000000001", nano::mbdm_ratio));
	ASSERT_EQ (1, amount.number ());
	ASSERT_TRUE (amount.decode_dec ("0.0000000000000000000000000000001", nano::mbdm_ratio));
	ASSERT_TRUE (amount.decode_dec (".1", nano::mbdm_ratio));
	ASSERT_TRUE (amount.decode_dec ("0.", nano::mbdm_ratio));
	ASSERT_FALSE (amount.decode_dec ("9.999999999999999999999999999999", nano::mbdm_ratio));
	...
	ASSERT_FALSE (amount.decode_dec ("1230", nano::Gbdm_ratio));
	ASSERT_EQ (1230 * nano::Gbdm_ratio, amount.number ());
}
