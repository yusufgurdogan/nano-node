...
// SI dividers
nano::uint128_t const Gbdm_ratio = nano::uint128_t ("100000"); // 10^5
nano::uint128_t const mbdm_ratio = nano::uint128_t ("100000"); // 10^5
nano::uint128_t const kbdm_ratio = nano::uint128_t ("100000"); // 10^5
nano::uint128_t const xrb_ratio = nano::uint128_t ("100"); // 10^2
